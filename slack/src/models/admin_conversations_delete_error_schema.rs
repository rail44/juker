...
pub struct AdminConversationsDeleteErrorSchema {
    #[serde(rename = "error")]
    pub error: Error,
    #[serde(rename = "ok")]
...
impl AdminConversationsDeleteErrorSchema {
    /// Schema for error response from admin.conversations.delete
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> AdminConversationsDeleteErrorSchema {
...
pub enum Error {
    ...
    RestrictedAction,
    #[serde(rename = "could_not_delete_channel")]
