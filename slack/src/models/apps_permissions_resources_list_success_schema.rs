...
pub struct AppsPermissionsResourcesListSuccessSchema {
    ...
    pub resources: Vec<crate::models::AppsPermissionsResourcesListSuccessSchemaResources>,
...
impl AppsPermissionsResourcesListSuccessSchema {
    ...
    pub fn new(ok: crate::models::DefsOkTrue, resources: Vec<crate::models::AppsPermissionsResourcesListSuccessSchemaResources>) -> AppsPermissionsResourcesListSuccessSchema {
