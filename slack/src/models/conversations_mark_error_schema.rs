...
pub struct ConversationsMarkErrorSchema {
...
impl ConversationsMarkErrorSchema {
    /// Schema for error response from conversations.mark method
    pub fn new(error: Error, ok: crate::models::DefsOkFalse) -> ConversationsMarkErrorSchema {
...
pub enum Error {
    ...
    UpgradeRequired,
    #[serde(rename = "not_allowed_token_type")]
    NotAllowedTokenType,
}
