...
/// Deletes a file.
pub async fn files_delete(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>) -> Result<crate::models::FilesDeleteSchema, Error<FilesDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn files_info(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>, count: Option<&str>, page: Option<&str>, limit: Option<i32>, cursor: Option<&str>) -> Result<crate::models::FilesInfoSchema, Error<FilesInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn files_list(configuration: &configuration::Configuration, token: Option<&str>, user: Option<&str>, channel: Option<&str>, ts_from: Option<f32>, ts_to: Option<f32>, types: Option<&str>, count: Option<&str>, page: Option<&str>, show_files_hidden_by_limit: Option<bool>) -> Result<crate::models::FilesListSchema, Error<FilesListError>> {
    let local_var_configuration = configuration;
...
pub async fn files_revoke_public_url(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>) -> Result<crate::models::FilesRevokePublicUrlSchema, Error<FilesRevokePublicUrlError>> {
    let local_var_configuration = configuration;
...
pub async fn files_shared_public_url(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>) -> Result<crate::models::FilesSharedPublicUrlSchema, Error<FilesSharedPublicUrlError>> {
    let local_var_configuration = configuration;
...
pub async fn files_upload(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>, content: Option<&str>, filetype: Option<&str>, filename: Option<&str>, title: Option<&str>, initial_comment: Option<&str>, channels: Option<&str>, thread_ts: Option<f32>) -> Result<crate::models::FilesUploadSchema, Error<FilesUploadError>> {
    let local_var_configuration = configuration;
