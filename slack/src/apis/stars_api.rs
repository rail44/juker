...
pub async fn stars_add(configuration: &configuration::Configuration, token: &str, channel: Option<&str>, file: Option<&str>, file_comment: Option<&str>, timestamp: Option<&str>) -> Result<crate::models::StarsAddSchema, Error<StarsAddError>> {
...
pub async fn stars_list(configuration: &configuration::Configuration, token: Option<&str>, count: Option<&str>, page: Option<&str>, cursor: Option<&str>, limit: Option<i32>) -> Result<crate::models::StarsListSchema, Error<StarsListError>> {
    let local_var_configuration = configuration;
...
pub async fn stars_remove(configuration: &configuration::Configuration, token: &str, channel: Option<&str>, file: Option<&str>, file_comment: Option<&str>, timestamp: Option<&str>) -> Result<crate::models::StarsRemoveSchema, Error<StarsRemoveError>> {
    let local_var_configuration = configuration;
